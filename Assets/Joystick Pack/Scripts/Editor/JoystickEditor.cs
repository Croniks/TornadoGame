...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty returnToStartingPosition;
    ...
    protected virtual void OnEnable()
    {
        ...
        returnToStartingPosition = serializedObject.FindProperty("returnToStartingPosition");
    }
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(returnToStartingPosition, new GUIContent("returnToStartingPosition", "(-_-)"));
    }
